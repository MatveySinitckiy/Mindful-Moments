...
function Firststep(){
    ...
    return<>
        ...
        <div className="w-[50%] h-[100%] items-center justify-center flex shadow-2xl shadow-stone-950/80"><img src='public/yogapp.jpg' className="border-purple-200"  alt="Скачай приложение" ></img></div>
    </div>
