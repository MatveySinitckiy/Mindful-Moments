    ...
    <div className="space-y-8">
      <div className="flex  feature-element flex-row" ref={addToRefs}>
        <div className="feature-image bg-purple-500">
          <img src='./yoga2.jpg' alt="yoga" className="w-[100%] h-[100%]" />
        </div>
      ...
      <div className="flex feature-element flex-row-reverse" ref={addToRefs}>
        <div className="feature-image bg-purple-500">
          <img src='./yoga3.jpg' alt="yoga" className="w-[100%] h-[100%]" />
        </div>
        <div className="feature-card">
      ...
      <div className="flex feature-element flex-row" ref={addToRefs}>
        <div className="feature-image bg-purple-500">
          <img src='./yoga4.jpg' alt="yoga" className="w-[100%] h-[100%]" />
        </div>
        <div className="feature-card">
          <h1>
      ...
      <div className="flex feature-element flex-row-reverse" ref={addToRefs}>
        <div className="feature-image bg-purple-500">
          <img src='./yoga5.jpg' alt="yoga" className="w-[100%] h-[100%]" />
        </div>
        <div className="feature-card">
          <h1>
